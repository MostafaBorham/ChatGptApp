...
class ConversationDesktopLayout extends StatefulWidget {
  const ConversationDesktopLayout({super.key});

  @override
  State<ConversationDesktopLayout> createState() => _ConversationDesktopLayoutState();
}

class _ConversationDesktopLayoutState extends State<ConversationDesktopLayout> {
  @override
  Widget build(BuildContext context) {
    return AutoSizeText('Conversation Desktop');
  }
}
