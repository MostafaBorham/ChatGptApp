...
extension IntegerExt on int {
  ...
  double hRatio() => AppResponsive.getHeightRatio(toDouble()); //h refer to Height
...
class AppResponsive {
  ...
  static double getSize(double size) {
    ...
    // print('$size - $appWidthXD - $currentWidth - $responsiveSize - $lowerLimit - $upperLimit - ${responsiveSize.clamp(lowerLimit, upperLimit)}');
